...
#ifndef SRC_TINYGSMCLIENTEC200U_H_
#define SRC_TINYGSMCLIENTEC200U_H_
// #pragma message("TinyGSM:  TinyGsmClientEC200U")
...
class TinyGsmEC200U : public TinyGsmModem<TinyGsmEC200U>,
                    public TinyGsmGPRS<TinyGsmEC200U>,
                    public TinyGsmTCP<TinyGsmEC200U, TINY_GSM_MUX_COUNT>,
                    public TinyGsmSSL<TinyGsmEC200U, TINY_GSM_MUX_COUNT>,
                    public TinyGsmCalling<TinyGsmEC200U>,
                    public TinyGsmSMS<TinyGsmEC200U>,
                    public TinyGsmGPS<TinyGsmEC200U>,
                    public TinyGsmTime<TinyGsmEC200U>,
                    public TinyGsmNTP<TinyGsmEC200U>,
                    public TinyGsmBattery<TinyGsmEC200U>,
                    public TinyGsmTemperature<TinyGsmEC200U> {
  friend class TinyGsmModem<TinyGsmEC200U>;
  friend class TinyGsmGPRS<TinyGsmEC200U>;
  friend class TinyGsmTCP<TinyGsmEC200U, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmSSL<TinyGsmEC200U, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmEC200U>;
  friend class TinyGsmSMS<TinyGsmEC200U>;
  friend class TinyGsmGPS<TinyGsmEC200U>;
  friend class TinyGsmTime<TinyGsmEC200U>;
  friend class TinyGsmNTP<TinyGsmEC200U>;
  friend class TinyGsmBattery<TinyGsmEC200U>;
  friend class TinyGsmTemperature<TinyGsmEC200U>;

  /*
   * Inner Client
   */
 public:
  class GsmClientEC200U : public GsmClient {
    friend class TinyGsmEC200U;

   public:
    GsmClientEC200U() {}

    explicit GsmClientEC200U(TinyGsmEC200U& modem, uint8_t mux = 0) {
      ssl_sock = false;
      init(&modem, mux);
    }

    bool init(TinyGsmEC200U* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
   ...
   */
 public:
  class GsmClientSecureEC200U : public GsmClientEC200U {
   public:
    GsmClientSecureEC200U() {}

    explicit GsmClientSecureEC200U(TinyGsmEC200U& modem, uint8_t mux = 0)
        : GsmClientEC200U(modem, mux) {
      ssl_sock = true;
    }
   ...
   */
 public:
  explicit TinyGsmEC200U(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = nullptr) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientEC200U"));
 ...
 protected:
   ...
   */
 public:
  EC200URegStatus getRegistrationStatus() {
    // Check first for EPS registration
    EC200URegStatus epsStatus = (EC200URegStatus)getRegistrationStatusXREG("CEREG");
    ...
    if (epsStatus == REG_OK_HOME || epsStatus == REG_OK_ROAMING) {
      ...
      return (EC200URegStatus)getRegistrationStatusXREG("CREG");
    }
  }

 protected:
  bool isNetworkConnectedImpl() {
    EC200URegStatus s = getRegistrationStatus();
 ...
 protected:
  ...
  // The EC200U returns UTC time instead of local time as other modules do in
 ...
 protected:
  GsmClientEC200U* sockets[TINY_GSM_MUX_COUNT];
  String         certificates[TINY_GSM_MUX_COUNT];
};

#endif  // SRC_TINYGSMCLIENTEC200U_H_
